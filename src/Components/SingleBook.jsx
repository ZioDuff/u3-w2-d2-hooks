...
const SingleBook = (props) => {
  ...
  return (
    <Card
      className="h-100"
      onClick={() => props.changeSelectedBook(props.asin)}
      style={{
        border: props.selectedBook === props.asin ? "3px solid red" : "",
      }}
    ...
    >
      <Card.Img variant="top" src={props.img} className="cards-image" />
      <Card.Body className="d-flex flex-column justify-content-between align-items-start">
        <Card.Title>{props.title}</Card.Title>
        <Card.Text className="mb-auto">{props.category}</Card.Text>
        <Badge variant="info">
